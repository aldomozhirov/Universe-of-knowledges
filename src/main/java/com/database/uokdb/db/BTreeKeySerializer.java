...
public abstract class BTreeKeySerializer<KEY, KEYS> {
	...
	public static final BTreeKeySerializer<Object, Object[]> BASIC = new BTreeKeySerializer.BasicKeySerializer(
			Serializer.BASIC, Fun.COMPARATOR);
	...
	public static final class BasicKeySerializer extends BTreeKeySerializer<Object, Object[]>implements Serializable {
		...
		BasicKeySerializer(SerializerBase serializerBase, DataInput is,
	...
	public static final BTreeKeySerializer<Long, long[]> LONG = new BTreeKeySerializer<Long, long[]>() {
		...
		public void serialize(DataOutput out, long[] keys) throws IOException {
			DataIO.DataOutputByteArray out2 = (DataIO.DataOutputByteArray) out; // TODO
																				// fallback
																				// option
																				// if
																				// cast
	...
	public static int commonPrefixLen(byte[][] bytes) {
		for (int ret = 0;; ret++) {
	...
	public static int commonPrefixLen(char[][] chars) {
	...
	public static final BTreeKeySerializer<String, StringArrayKeys> STRING = new BTreeKeySerializer<String, StringArrayKeys>() {
		...
		public StringArrayKeys deserialize(DataInput in, int nodeSize) throws IOException {
			...
			return useUnicode ? new CharArrayKeys(in, offsets, prefixLen) : new ByteArrayKeys(in, offsets, prefixLen);
		}
	...
	public static class Compress extends BTreeKeySerializer {
		...
		public Compress(SerializerBase serializerBase, DataInput in, SerializerBase.FastArrayList objectStack)
				throws IOException {
			objectStack.add(this);
