...
public abstract class Volume implements Closeable{
    ...
    public static final Logger LOG = Logger.getLogger(Volume.class.getName());
...
//                        ,constructorStackTrace
    ...
    abstract static public class ByteBufferVol extends Volume{
        ...
        public final  boolean cleanerHackEnabled;

        public final ReentrantLock growLock = new ReentrantLock(CC.FAIR_LOCKS);
        public final int sliceShift;
        public final int sliceSizeModMask;
        public final int sliceSize;

        public volatile ByteBuffer[] slices = new ByteBuffer[0];
        public final boolean readOnly;

        public ByteBufferVol(boolean readOnly, int sliceShift, boolean cleanerHackEnabled) {
        ...
        public final ByteBuffer getSlice(long offset){
        ...
        public static byte toByte(int byt) {
        ...
        public static boolean unmap(MappedByteBuffer b){
            try{
    ...
    abstract static public class ByteBufferVolSingle extends Volume{
        ...
        public ByteBufferVolSingle(boolean readOnly, long maxSize, boolean cleanerHackEnabled) {
            //TODO assert size
            this.readOnly = readOnly;
...
//                    sync();
    ...
    public static final class FileChannelVol extends Volume {
        ...
        public final Lock growLock = new ReentrantLock(CC.FAIR_LOCKS);
    ...
    public static final class ByteArrayVol extends Volume{
        ...
        public volatile byte[][] slices = new byte[0][];
