...
public class SerializerPojo extends SerializerBase implements Serializable{
    ...
    public final Serializer<ClassInfo> classInfoSerializer = new Serializer<ClassInfo>() {
    ...
    public static final Fun.Function1<Class, String> DEFAULT_CLASS_LOADER = new Fun.Function1<Class, String>() {
        @Override
    ...
    public final Fun.Function1<String,Object> getNameForObject;
    public final Fun.Function1<Object,String> getNamedObject;

    public final Fun.Function0<ClassInfo[]> getClassInfos;
    public final Fun.Function1Int<ClassInfo> getClassInfo;
    public final Fun.Function1<Void,String> notifyMissingClassInfo;
    public final Fun.Function1<Class, String> classLoader;
    ...
    public static boolean usesAdvancedSerialization(Class<?> clazz) {
    ...
    public static ObjectStreamField[] fieldsForClass(ClassInfo[] classes, Class<?> clazz) {
...
//            classInfo.setObjectStreamFields(fields);
    ...
    public void assertClassSerializable(ClassInfo[] classes, Class<?> clazz) throws NotSerializableException, InvalidClassException {
...
//                saveClassInfo();
    ...
    @Override
    public Object deserializeUnknownHeader(DataInput in, int head, FastArrayList<Object> objectStack) throws IOException {
    ...
    static public Method sunConstructor = null;
    static public Object sunReflFac = null;
    static public Method androidConstructor = null;
    ...
    public static Map<Class<?>, Constructor<?>> class2constuctor = new ConcurrentHashMap<Class<?>, Constructor<?>>();

    @SuppressWarnings("restriction")
	public <T> T createInstanceSkippinkConstructor(Class<T> clazz) {
    ...
    public final class ObjectOutputStream2 extends ObjectOutputStream{
        ...
        public ObjectOutputStream2(OutputStream out, ClassInfo[] classes) throws IOException, SecurityException {
            super(out);
    ...
    public final class ObjectInputStream2 extends ObjectInputStream{
        ...
        public ObjectInputStream2(DataInput in, ClassInfo[] classes) throws IOException, SecurityException {
