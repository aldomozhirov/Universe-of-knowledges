...
public class WriteAheadLog {
    ...
    public static final int WAL_STORE_VERSION = 100;

    /** 4 byte file header */
    public static final int WAL_HEADER = (0x8A77<<16) | WAL_STORE_VERSION;


    public static final long WAL_SEAL = 8234892392398238983L;

    public static final int I_EOF = 0;
    public static final int I_LONG = 1;
    public static final int I_BYTE_ARRAY = 2;
    public static final int I_SKIP_MANY = 3;
    public static final int I_SKIP_SINGLE = 4;
    public static final int I_RECORD = 5;
    public static final int I_TOMBSTONE = 6;
    public static final int I_PREALLOCATE = 7;
    public static final int I_COMMIT = 8;
    public static final int I_ROLLBACK = 9;

    public static final long MAX_FILE_SIZE = 16L * 1024L * 1024L;
    public static final long MAX_FILE_RESERVE = 16;


    public final long featureBitMap;

    public final int pointerOffsetBites=32;
    public final long pointerOffsetMask = DataIO.fillLowBits(pointerOffsetBites);
    public final int pointerSizeBites=16;
    public final long pointerSizeMask = DataIO.fillLowBits(pointerSizeBites);
    public final int pointerFileBites=16;
    public final long pointerFileMask = DataIO.fillLowBits(pointerFileBites);

    public int lastChecksum=0;
    public long lastChecksumOffset=16;
    ...
    public int checksum(Volume vol, long startOffset, long endOffset){
    ...
    public volatile long fileOffset = 16;
    public ReentrantLock fileOffsetLock = new ReentrantLock(CC.FAIR_LOCKS);

    public final List<Volume> volumes = Collections.synchronizedList(new ArrayList<Volume>());

    public final List<Volume> walRec = Collections.synchronizedList(new ArrayList<Volume>());

    public Volume curVol;

    public long fileNum = -1;

    public long allocate(final int reqSize, final int optSize){
    ...
    public void fileOffsetSet(long fileOffset){
        fileOffsetLock.lock();
        try{
...
//                    wal.getData(pos, data, 0, data.length);
    ...
    public String getWalFileName(String ext) {
    ...
    public long walPointerToOffset(long walPointer) {
        return walPointer & pointerOffsetMask;
    }

    public long walPointerToFileNum(long walPointer) {
        return (walPointer >>> (pointerOffsetBites)) & pointerFileMask;
    }

    public int walPointerToSize(long walPointer) {
    ...
    public long walPointer(long size, long fileNum, long offset){
    ...
    public void ensureFileReady(boolean addressable) {
        if(curVol==null){
            startNextFile();
            return;
        }
