...
public abstract class Serializer<A> {
    ...
    abstract public static class EightByteSerializer<E> extends Serializer<E>{

        public abstract E unpack(long l);
        public abstract long pack(E l);
    ...
    abstract public static class LongSerializer extends EightByteSerializer<Long> {

        @Override
        public Long unpack(long l) {
            return new Long(l);
        }
    ...
    abstract public static class FourByteSerializer<E> extends Serializer<E>{

        public abstract E unpack(int l);
        public abstract int pack(E l);
    ...
    abstract public static class IntegerSerializer extends FourByteSerializer<Integer> {

        @Override
        public Integer unpack(int l) {
            return l;
        }

        @Override
        public int pack(Integer l) {
            return l;
        }
    ...
    public static class BooleanSer extends Serializer<Boolean> {
    ...
    public static final Serializer<Float> FLOAT = new FourByteSerializer<Float>() {
        ...
        @Override
        public Float unpack(int l) {
            return Float.intBitsToFloat(l);
        }

        @Override
        public int pack(Float l) {
    ...
    public static final Serializer<Double> DOUBLE = new EightByteSerializer<Double>() {
        @Override
        public Double unpack(long l) {
            return Double.longBitsToDouble(l);
        }

        @Override
        public long pack(Double l) {
    ...
    public static final Serializer<Date> DATE = new EightByteSerializer<Date>() {
        ...
        @Override
        public Date unpack(long l) {
            return new Date(l);
        }

        @Override
        public long pack(Date l) {
            return l.getTime();
        }
    };
    ...
    public final static class CompressionWrapper<E> extends Serializer<E> implements Serializable {
        ...
        public final ThreadLocal<CompressLZF> LZF = new ThreadLocal<CompressLZF>() {
            @Override public CompressLZF initialValue() {
		...
		public CompressionWrapper(SerializerBase serializerBase, DataInput is, SerializerBase.FastArrayList<Object> objectStack, boolean compressValues) throws IOException {
    ...
    public final static class CompressionDeflateWrapper<E> extends Serializer<E> implements Serializable {
        ...
        @SuppressWarnings("unchecked")
        public CompressionDeflateWrapper(SerializerBase serializerBase, DataInput is, SerializerBase.FastArrayList<Object> objectStack) throws IOException {
            objectStack.add(this);
            this.serializer = (Serializer<E>) serializerBase.deserialize(is,objectStack);
    ...
    public static final class Array<T> extends Serializer<T[]> implements  Serializable{
        ...
        @SuppressWarnings("unchecked")
		public Array(SerializerBase serializerBase, DataInput is, SerializerBase.FastArrayList<Object> objectStack) throws IOException {
            objectStack.add(this);
