...
public class SerializerBase extends Serializer<Object>{
    ...
    public static final class DeserSerializer extends Deser {
    ...
    public final class SerHeader implements Ser{
    ...
    public static final class SerHeaderSerializer implements Ser{
    ...
    public final Map<Class, Ser> ser = new IdentityHashMap<Class, Ser>();

    public final Deser[] headerDeser = new Deser[255];
    ...
    public static final Ser SER_STRING = new Ser<String>(){
        @Override
    ...
    public static final Ser SER_LONG_ARRAY = new Ser<long[]>() {
        @Override
    ...
    public static final Ser SER_INT_ARRAY = new Ser<int[]>() {
        @Override
    ...
    public static final Ser SER_DOUBLE = new Ser<Double>() {
        @Override
    ...
    public static final Ser SER_FLOAT = new Ser<Float>() {
        @Override
    ...
    public static final Ser SER_SHORT = new Ser<Short>() {
        @Override
    ...
    public static final Ser SER_CHAR = new Ser<Character>() {
        @Override
    ...
    public static final Ser SER_BYTE= new Ser<Byte>() {
        @Override
    ...
    public static final Ser SER_BOOLEAN = new Ser<Boolean>() {
        @Override
    ...
    public static final Ser SER_LONG = new Ser<Long>() {
        @Override
    ...
    public static final Ser SER_INT = new Ser<Integer>() {
        @Override
    ...
    public void serializeClass(DataOutput out, Class clazz) throws IOException {
    ...
    public static final Ser<byte[]> SER_BYTE_ARRAY = new Ser<byte[]>() {
        @Override
    ...
    public interface HeaderMapDB{
        ...
        public final Map<Object,Integer> mapdb_all = new IdentityHashMap<Object, Integer>();
        public final Store.LongObjectMap<Object> mapdb_reverse = new Store.LongObjectMap<Object>();
    ...
    public Object deserializeMapDB(DataInput is, FastArrayList<Object> objectStack) throws IOException {
    ...
    public Class deserializeClass(DataInput is) throws IOException {
    ...
    public void serializeUnknownObject(DataOutput out, Object obj, FastArrayList<Object> objectStack) throws IOException {
        throw new NotSerializableException("Could not serialize unknown object: "+obj.getClass().getName());
    }
    /** override this method to extend SerializerBase functionality*/
    public Object deserializeUnknownHeader(DataInput is, int head, FastArrayList<Object> objectStack) throws IOException {
        throw new DBException.DataCorruption("Unknown serialization header: " + head);
    }

    public static void  writeBooleanArray(DataOutput out, boolean[] bool) throws IOException {
        int pos = 0;
        for(;pos<bool.length;){
            int v = 0;
    ...
    public static boolean[] readBooleanArray(int numBools,DataInput is) throws IOException {
